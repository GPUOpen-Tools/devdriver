...
> If you need to build `messagelib`, you will have to set two environment variables.
>
> - `DK_ROOT = <your dxcp_dk dir>/dk/win`
> - `DRIVERS_ROOT = <your dxcp driver root dir>/drivers/` (basically the parent dir of dx/dxcp)
>
> These two variables define the paths to the driver code base.
...
> ## Contributing to DevDriver
>
> ### C++ Coding Standard
>
> DevDriver follows a defined C++ coding standard, which can be found [here](CONTRIBUTING.md).
>
> ### Tests
>
> All tests must pass for code to be checked in.
> To run all tests for the core C++ code, go to the build directory and run:
>
> ```sh
> $ ctest
> ```
...
> ## Releases
>
> Please refer to instructions [here](RELEASES.md).
