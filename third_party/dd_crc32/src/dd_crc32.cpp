...
uint32_t CRC32(const void* pData, size_t length, uint32_t lastCRC)
{
    static constexpr uint32_t LookupTable[256] =
    {
    ...
    const unsigned char* pCurrent = static_cast<const unsigned char*>(pData);
