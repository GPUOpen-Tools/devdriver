...
The sanitizer has an error if the vendor name is found, so [VENDOR] is used in the URL below
```bash
git clone --branch=v1.1.0 --depth=1 https://github.com/[VENDOR]/rapidjson.git rapidjson.git
