...
function(apply_devdriver_warnings name)
    if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang|AppleClang")
        target_compile_options(${name} PRIVATE
            ...
            -Wformat                # Warn on format string issues.
            -Wformat-security       # Warn on security-sensitive format issues.
...
function(apply_devdriver_compile_definitions name)
    ...
    target_compile_definitions(${name} PUBLIC DD_LOCAL_NG_TRANSPORT)
