...
namespace DevDriver
{
    ...
    Result LegacyProtocolClient::WaitForDisconnection(uint32 timeoutMillis)
    {
        return m_pSession->WaitForDisconnection(timeoutMillis);
    }

    Result LegacyProtocolClient::TransactPayloadContainer(
