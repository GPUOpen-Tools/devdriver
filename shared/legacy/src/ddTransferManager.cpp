...
namespace DevDriver
{
    ...
    {
        // ============================================================================================================
        ServerBlock::ServerBlock(const AllocCb& allocCb, BlockId blockId)
        ...
        // ============================================================================================================
        bool ServerBlock::IsClosed() const
        {
            return m_isClosed;
        }

        // ============================================================================================================
        uint32 ServerBlock::GetCrc32() const
        {
            return m_crc32;
        }

        // ============================================================================================================
        PullBlock::PullBlock(IMsgChannel* pMsgChannel, BlockId blockId)
            : TransferBlock(blockId)
        ...
        // ============================================================================================================
        PushBlock::PushBlock(IMsgChannel* pMsgChannel, BlockId blockId)
            : TransferBlock(blockId)
            , m_transferClient(pMsgChannel)
        {
        }
        ...
        void ServerBlock::Write(const void* pSrcBuffer, size_t numBytes)
        {
            ...
            if (numBytes > 0)
            {
                ...
                Platform::Memcpy_s(pData, numBytes, pSrcBuffer, numBytes);
