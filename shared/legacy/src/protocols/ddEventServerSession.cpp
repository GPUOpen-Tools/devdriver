...
SessionId EventServerSession::GetSessionId()
{
    ...
    switch (m_state)
    {
        ...
        case SessionState::ProcessPayload:
        {
            ...
            switch (container.GetPayload<EventHeader>().command)
            {
                ...
                case EventMessage::Unknown:
                case EventMessage::QueryProvidersResponse:
                case EventMessage::AllocateProviderUpdatesResponse:
                case EventMessage::ApplyProviderUpdatesResponse:
                case EventMessage::EventDataUpdate:
                case EventMessage::SubscribeToProviderResponse:
                case EventMessage::Count:
                default:
                    DD_UNREACHABLE();
                    break;
            }
