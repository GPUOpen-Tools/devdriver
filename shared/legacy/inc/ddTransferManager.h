...
namespace DevDriver
{
    ...
    namespace TransferProtocol
    {
        ...
        public:
            ...
            ServerBlock(ServerBlock&&) = delete;
            ServerBlock& operator=(const ServerBlock&) = delete;
            ServerBlock& operator=(ServerBlock&&) = delete;
        ...
        public:
            PullBlock(const PullBlock&) = delete;
            PullBlock(PullBlock&&) = delete;
            PullBlock& operator=(const PullBlock&) = delete;
            PullBlock& operator=(PullBlock&&) = delete;
        ...
        class PushBlock final : public TransferBlock
        {
            friend class TransferManager;
        public:
            PushBlock(const PushBlock&) = delete;
            PushBlock(PushBlock&&) = delete;
            PushBlock& operator=(const PushBlock&) = delete;
            PushBlock& operator=(PushBlock&&) = delete;
