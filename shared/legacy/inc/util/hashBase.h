...
namespace DevDriver
{
    ...
    protected:
        ...
        HashBase(const HashBase& other) = delete;
        HashBase& operator=(const HashBase& other) = delete;
            ...
            m_curBlock(Platform::Exchange(rhs.m_curBlock, -1))
        {
            ...
            Platform::Memcpy_s(m_blocks, sizeof(m_blocks), rhs.m_blocks, sizeof(m_blocks));
            ...
            Platform::Memcpy_s(m_buckets, sizeof(m_buckets), rhs.m_buckets, sizeof(m_buckets));
            // Reset the object on the right hand side
