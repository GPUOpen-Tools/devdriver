...
namespace DevDriver
{
    namespace TransferProtocol
    {
        ...
        DD_NETWORK_STRUCT(TransferHeader, 4)
        {
            ...
            TransferHeader(TransferMessage message = TransferMessage::Unknown);
        };
        ...
        DD_NETWORK_STRUCT(TransferRequest, 4)
        {
            ...
            TransferRequest(BlockId blockId, TransferType type, uint32 size);
        };
        ...
        DD_NETWORK_STRUCT(TransferDataHeader, 4)
        {
            ...
            TransferDataHeader(Result result, uint32 size);
        };
        ...
        DD_NETWORK_STRUCT(TransferDataHeaderV2, 4)
        {
            ...
            TransferDataHeaderV2(uint32 size);
        };
        ...
        DD_NETWORK_STRUCT(TransferDataSentinel, 4)
        {
            ...
            TransferDataSentinel(Result result, uint32 crc32);
        };
