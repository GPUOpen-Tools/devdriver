    ...
    namespace EventProtocol
    {
        ...
        DD_NETWORK_STRUCT(EventDataUpdatePayload, 4)
        {
                ...
                : header(EventMessage::EventDataUpdate)
            {
                ...
                Platform::Memcpy_s(eventData, kMaxEventDataSize, pEventData, clampedEventDataSize);
        ...
        struct EventChunk
        {
            ...
            Result Write(const void* pEventData, size_t eventDataSize)
            {
                ...
                {
                    Platform::Memcpy_s(data + dataSize, CalculateBytesRemaining(), pEventData, eventDataSize);
