...
void ClientServerTest::SetUp()
{
    ...
    Platform::Strncpy(serverCreateInfo.clientDescription, "Test UMD", sizeof(serverCreateInfo.clientDescription));
    ...
    serverCreateInfo.servers.bits.logging       = true;
    serverCreateInfo.servers.bits.settings      = true;
    serverCreateInfo.servers.bits.driverControl = true;
    serverCreateInfo.servers.bits.rgp           = true;
    serverCreateInfo.servers.bits.event         = true;
#else
