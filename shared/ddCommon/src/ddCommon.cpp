    ...
    , m_bytesWritten(0)
{
    ...
    m_writer.pfnWriteBytes = [](void* pUserdata, const void* pData, size_t dataSize) -> DD_RESULT {
        ...
        Platform::Memcpy_s(reinterpret_cast<uint8_t*>(pThis->m_pBuffer) + pThis->m_bytesWritten,
                           pThis->m_bufferSize - pThis->m_bytesWritten,
                           pData,
                           bytesToWrite);
    ...
    : m_buffer(Platform::GenericAllocCb)
{
    ...
    m_writer.pfnWriteBytes = [](void* pUserdata, const void* pData, size_t dataSize) -> DD_RESULT {
        ...
        Platform::Memcpy_s(&pThis->m_buffer[oldSize], dataSize, pData, dataSize);
