...
public:
    ...
    {
        static_assert(DevDriver::Platform::IsPod<T>::Value, "To use a type in a FixedByteBufferByteWriter, it must be POD!");
    }
...
// This is mostly used to make sure DD_FILE and company are set-up correctly.
#define DD_MAKE_LOG_EVENT(level, category) ::DDInternal::MakeEventHelper(level, category, DD_FILE, __FUNCTION__, __LINE__)
